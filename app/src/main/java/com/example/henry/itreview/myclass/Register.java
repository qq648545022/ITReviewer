...
public class Register{
        ...
        public static String  connect(String username,String password1,String password2,String sex,String country,String age)throws IOException{
...
//            String age = "20";
            ...
            String data = String.format("username=%s&password1=%s&password2=%s&sex=%s&country=%s&age=%s",username, password1, password2, sex, country, age);
            String s =(Post("http://172.29.23.128/register", data));
